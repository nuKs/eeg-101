...
public class Provider extends ContentProvider {
    ...
    // content://org.pnplab.flux.aware_plugins.eegmuse.provider.eegmuse/eegmuse

    public static String AUTHORITY = "org.pnplab.flux.aware_plugins.eegmuse.provider.eegmuse"; //change to package.provider.your_plugin_name
    ...
    public static final class EEGMuse_Data implements AWAREColumns {
        ...
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.org.pnplab.flux.aware_plugins.eegmuse.provider.eegmuse"; //modify me
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.org.pnplab.flux.aware_plugins.eegmuse.provider.eegmuse"; //modify me
