        ...
        <View style={styles.modalBackground}>
          <View style={styles.modalInnerContainer}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={{ flex: 1 }}>
                <CleanButton onPress={this.props.onClose}>
                  {I18n.t("closeButton")}
                </CleanButton>
              </View>
            </View>
...
export class ConnectorWidget extends Component {
  constructor(props) {
    super(props);
      ...
      default:
        return (
          <View style={styles.container}>
            ...
            <CleanButton onPress={() => this.getAndConnectToDevice()}>
              {I18n.t("search")}
            </CleanButton>
          </View>
        );
...
export default connect(mapStateToProps, mapDispatchToProps)(ConnectorWidget);
