package org.pnplab.flux.components.csv;
...
public class EEGFileWriter {
    ...
    public void sendData(File dataCSV) {
        ...
        sendIntent.putExtra(Intent.EXTRA_STREAM, fileProvider.getUriForFile(this.context, "org.pnplab.flux.fileprovider", dataCSV));
