...
public class Provider extends ContentProvider {
    ...
    // content://com.aware.plugin.questionnaire.provider.questionnaire/questionnaire

    public static String AUTHORITY = "pnplab.flux.aware_plugins.questionnaire.provider.questionnaire"; //change to package.provider.your_plugin_name
    ...
    public static final String DB_TBL_TEMPLATE = "questionnaire";
    ...
    public static final class Questionnaire_Data implements AWAREColumns {
        ...
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.pnplab.flux.aware_plugins.questionnaire.provider.questionnaire"; //modify me
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.pnplab.flux.aware_plugins.questionnaire.provider.questionnaire"; //modify me
    ...
    public static String getAuthority(Context context) {
        AUTHORITY = context.getPackageName() + ".provider.questionnaire";
        return AUTHORITY;
    }
