package com.eeg_project.aware_plugins.eegmuse;
...
public class Provider extends ContentProvider {
    ...
    // content://com.eeg_project.aware_plugins.eegmuse.provider.eegmuse/eegmuse

    public static String AUTHORITY = "com.eeg_project.aware_plugins.eegmuse.provider.eegmuse"; //change to package.provider.your_plugin_name
    ...
    public static final String DATABASE_NAME = "plugin_eegmuse.db"; //the database filename, use plugin_xxx for plugins.
    ...
    public static final class EEGMuse_Data implements AWAREColumns {
        ...
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.eeg_project.aware_plugins.eegmuse.provider.eegmuse"; //modify me
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.eeg_project.aware_plugins.eegmuse.provider.eegmuse"; //modify me
